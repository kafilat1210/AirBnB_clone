...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        h = "Quit command to exit the console"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_EOF(self):
        h = "Ctrl-D to exit the console"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))

    def test_help_create(self):
        h = ("Creates a new instance of BaseModel, saves it and \
prints the id. Ex:\n"
    ...
    def test_help_show(self):
        h = ("Prints the string representation of an instance. Ex:\n"
    ...
    def test_help_destroy(self):
        h = ("Deletes an instance based on the class name and id. Ex:\n"
    ...
    def test_help_all(self):
        h = ("Prints all string representation of all instances. Ex:\n"
             "        (hbnb) all <class name>\n"
             "or      (hbnb) all")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_count(self):
        h = ("Retrieves the number of instances of a class. Ex:\n"
    ...
    def test_help_update(self):
        h = ("Updates an instance based on the class name and id Ex:\n"
             "       (hbnb) update <class name> <id> <attribute name> \
\"<attribute value>\"")
        with patch("sys.stdout", new=StringIO()) as output:
